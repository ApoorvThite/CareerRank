"""
Train Bi-Encoder Model with Contrastive Learning (Fixed Import)
...
# Fix transformers packaging import issue
import transformers.utils.versions as versions
original_require = versions.require_version
...
def patched_require(requirement, hint=None):
    try:
        ...
        if 'packaging' in str(e):
            return  # Skip packaging version check
        raise

versions.require_version = patched_require
versions.require_version_core = patched_require
